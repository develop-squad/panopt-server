...
<h1 align="center">에코 테스트<h4 align="center">데이터 송수신 테스트를 위한 에코입니다</h4></h1>
...
### OUTPUT EXAMPLE  
`{ "type": GET/POST, "data": received data }`  
...
<h1 align="center">알림 이벤트 폴링<h4 align="center">클라이언트로의 이벤트 알림이 있는지 확인합니다</h4></h1>
